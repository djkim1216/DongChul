...
public class CategoryReviewBizImpl implements CategoryReviewBiz{
	...
	@Override
	public List<CategoryReviewDto> selectList(String start, String end, String keyword, String category) {
		if(keyword == null) {
			keyword = "%%";
		} else {
			keyword = "%" + keyword + "%";
		...
		List<CategoryReviewDto> output = dao.selectList(start, end, keyword, changeStr);
